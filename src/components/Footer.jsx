...
const Footer = () => {
  ...
  return (
      <footer className="bg-gray-900/50 border-t border-gray-800 w-full clear-both">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-left">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="space-y-4 col-span-1 sm:col-span-2 md:col-span-1"
            >
              <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">
                Zephania Owuor
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                Building practical software solutions for web platforms, systems architecture, and creative applications.
              </p>
                ...
                >
                  ...
                  <ul className="space-y-2.5">
                    {column.links.map((link, linkIndex) => (
                        <li key={linkIndex} className="overflow-hidden list-none">
                          {link.isExternal ? (
                              <motion.a
                                  href={link.to}
                                  target="_blank"
